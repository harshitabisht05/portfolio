        ...
        <div className="grid min-h-[700px] items-center gap-12 lg:grid-cols-2 lg:gap-20">
          ...
          >
            ...
            <p className="mb-10 max-w-xl text-lg leading-8 text-gray-400">
              Creating responsive and interactive web applications with a strong focus on frontend development, backed by APIs, databases, and modern backend technologies.
            </p>

            {/* <div className="flex flex-wrap gap-4">
              <a href="#projects" className="rounded-full bg-gradient-to-r from-blue-500 to-cyan-400 px-8 py-4 font-semibold transition duration-300 hover:scale-105">
                View Projects
                </a>
                

              <a href="/resume.pdf" target="_blank" rel="noreferrer" className="rounded-full border border-white/10 bg-white/5 px-8 py-4 backdrop-blur-xl transition duration-300 hover:border-blue-400">
              Resume
              </a>
